...
/*
  la fonction resolv convertit un nom d'hote (nom de domaine ou aaa.bbb.ccc.ddd)
  et un nom de service en une adresse IP exprimee sous la forme d'une structure
  struct sockaddr_in dont elle retourne l'adresse;
...
/*
  ...
  dans l'orde de l'hote en une adresse IP exprimee sous forme d'une chaine
  aaa.bbb.ccc.ddd;
